  ...
  return (
    <Card variant='green'>
      ...
      <Modal 
        ...
        onClose={() => { setShowBlockModal(false); resetWizard(); }}
        className={(wizardState === 'asking' || wizardState === 'response') ? 'max-w-lg' : 'max-w-md'}
      >
        {/* Column layout for wizard states */}
        {(wizardState === 'asking' || wizardState === 'response') ? (
          <div className='flex gap-4'>
            {/* Left Column - Wizard Image */}
            <div className='w-1/3 flex items-center'>
              <img src='/images/grey-wizard.png' alt='Wizard' className='w-full rounded' />
            </div>
          ...
          /* Just content for idle and final states */
          <>
            {wizardState === 'idle' && (
              <>
